...
export default function FashionRetailLandingPage() {
    ...
    return (
        <main ref={containerRef} className="min-h-screen bg-white overflow-hidden text-vyr-wine-dark">
            ...
            {/* 1. Hero Section: High Impact, Light & Premium */}
            <section className="relative w-full min-h-[90vh] flex items-center pt-24 pb-12 bg-[#FFEBF4]">
                <div className="absolute inset-0 z-0">
                    <div className="absolute inset-0 bg-[url('https://images.unsplash.com/photo-1566958769312-82cef41d73b8?auto=format&fit=crop&q=80')] bg-cover bg-center opacity-5 mix-blend-multiply grayscale" />
                    <div className="absolute inset-0 bg-gradient-to-t from-white via-transparent to-transparent" />
                    <div className="absolute right-0 top-0 w-1/2 h-full bg-vyr-wine-light blur-[150px] opacity-20 pointer-events-none" />
                </div>
