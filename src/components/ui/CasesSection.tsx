                            ...
                            <div className="relative h-full bg-[#0A0A0C] rounded-[calc(1.5rem-1px)] p-8 md:p-10 flex flex-col justify-between">
                                <div>
                                    <div className="flex justify-between items-start mb-8">
                                        ...
                                        <div className="px-3 py-1 rounded-full bg-white/5 text-xs text-vyr-text-muted font-medium border border-white/5">
                                            {item.client}
                                        </div>
                                    </div>
                                    ...
                                    <div className="mb-2">
                                        ...
                                        <div className="text-sm text-vyr-wine-light font-medium uppercase tracking-wider">{item.label}</div>
                                    </div>
